// Added line 148
// Edited line 214, previously: xLabel.attr('text', _this.columnLabels[index]);
// Changed line 213 - 218
(function () {
    var $, Morris;
    ...
    Morris.Line = (function () {
        ...
        Line.prototype.precalc = function () {
            var ykey, ymax, ymin, _i, _j, _len, _ref, _ref2, _results, _this = this;
        ...
        Line.prototype.redraw = function () {
            ...
            for (i = _ref = Math.ceil(this.xmin), _ref2 = Math.floor(this.xmax); _ref <= _ref2 ? i <= _ref2 : i >= _ref2; _ref <= _ref2 ? i++ : i--) {
                ...
                // RWC
                window.words.drawEvent(labelText, labelBox.x, labelBox.width);
            ...
            updateHover = function (index) {
                var i, maxLabelWidth, xloc, yloc, _ref8, min = 80 - index;
                hoverSet.show();

                xLabel.attr('text', 'Minute ' + _this.columnLabels[index]);
